...
aws s3 cp s3://vesta-intern-anthony/models/segment-anything/pretrained/sam_vit_h_4b8939.pth ./video_panoptic_segmentation/models/segment-anything/segment-anything/checkpoints/
...
aws s3 cp ${EXPERIMENT_NAME}.tar.gz s3://vesta-intern-anthony/results/segment-anything/
