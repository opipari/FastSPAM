...
python video_segmentation/metrics/evaluate_iVPQ.py --rle_path ./results/ov2seg_swin --ref_path ./video_segmentation/datasets/MVPd/MVPd --ref_split test --compute --vkn
