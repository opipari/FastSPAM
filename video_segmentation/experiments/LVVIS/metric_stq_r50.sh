...
python video_segmentation/metrics/evaluate_STQ.py --rle_path ./results/ov2seg_resnet50 --ref_path ./video_segmentation/datasets/MVPd/MVPd --ref_split test --compute

rm -rf ./results/ov2seg_resnet50/panomasksRLE
mv res.json results/
