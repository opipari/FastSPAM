...
aws s3 cp s3://vesta-intern-anthony/video_panoptic_segmentation/datasets/MVPd/MVPd/MVPd_test_coco_2.json ./MVPd/ > /dev/null
mv ./MVPd/MVPd_test_coco_2.json ./MVPd/MVPd_test_coco.json
...
aws s3 cp s3://vesta-intern-anthony/video_panoptic_segmentation/models/LLVIS/models/swin_model_final_4.pth ./ > /dev/null
cd ..
echo "Downloaded pretrained models"

./scripts/eval_video_mvpd_swin.sh
