...
aws s3 cp s3://vesta-intern-anthony/video_panoptic_segmentation/datasets/MVPd/MVPd/MVPd_test_coco_3.json ./MVPd/ > /dev/null
mv ./MVPd/MVPd_test_coco_3.json ./MVPd/MVPd_test_coco.json
