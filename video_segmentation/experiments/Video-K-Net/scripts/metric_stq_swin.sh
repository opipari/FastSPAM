...
cd results
aws s3 cp s3://vesta-intern-anthony/video_panoptic_segmentation/models/Video-K-Net/results/vkn_swinb_metrics.tar.gz ./ > /dev/null
tar -xf vkn_swinb_metrics.tar.gz
rm vkn_swinb_metrics.tar.gz
cd ..
