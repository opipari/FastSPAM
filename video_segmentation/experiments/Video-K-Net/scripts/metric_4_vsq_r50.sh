...
python video_segmentation/metrics/evaluate_iVPQ.py --rle_path ./results/test_instance_r50_300lengthvids --ref_path ./video_segmentation/datasets/MVPd/MVPd --ref_split test --compute --vkn
