...
cd results
aws s3 cp s3://vesta-intern-anthony/video_panoptic_segmentation/models/Video-K-Net/results/test_instance_swin_300lengthvids.tar.gz ./ > /dev/null
tar -xf test_instance_swin_300lengthvids.tar.gz
rm test_instance_swin_300lengthvids.tar.gz
cd ..
