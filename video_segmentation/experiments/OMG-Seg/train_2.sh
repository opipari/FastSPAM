...
aws s3 cp s3://vesta-intern-anthony/video_panoptic_segmentation/datasets/MVPd/MVPd/train_annotations_2.json ./MVPd/ > /dev/null
mv MVPd/train_annotations_2.json MVPd/train_annotations.json
...
mkdir models
cd models
aws s3 cp s3://vesta-intern-anthony/video_panoptic_segmentation/models/OMG-Seg/models/iter_50000.pth ./ > /dev/null
cd ..
echo "Downloaded pretrained models"


./tools/dist.sh gen_cls seg/configs/m2ov_val/eval_m2_convl_300q_ov_mvpd.py 1
./tools/dist.sh train seg/configs/m2ov_train/omg_convl_vlm_fix_12e_ov_mvpd_2.py 8
